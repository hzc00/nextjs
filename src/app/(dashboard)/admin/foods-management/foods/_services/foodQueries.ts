...
const getFoods = async (
  ...
  if (numericMinCalories || numericMaxCalories) {
    where.calories = {
      gte: numericMinCalories,
      lte: numericMaxCalories,
    };
  }
  ...
  if (numericMinProtein || numericMaxProtein) {
    where.protein = {
      gte: numericMinProtein,
      lte: numericMaxProtein,
    };
  }
